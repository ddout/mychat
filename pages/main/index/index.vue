		...
		methods: {
			...
			pushMsg(resMsg){
				...
				let datas = {
					...
					"content": resMsg,
					"type": 0,
					"pic": "https://7765-web-9gikcbug35bad3a8-1304825656.tcb.qcloud.la/img_springboot.png?sign=d56ecf364158884cff2f7d63f51687f9&t=1640170829"
				}
...
或者可以问我其他问题\n越完整的描述，我越精确`, // 消息内容
			...
			async send() {
				...
				if(taht.content.substr(0,4) === '授权码='){
					taht.aesKey = taht.content.substr(4)
					taht.pushMsg('授权码已存储,我可以开始服务了')
					return;
				}
				/////////
				let sendData={
				...
				getGPT(taht.aesKey , sendData).then(res=>{
					////////
					taht.pushMsg(res)
					/////////
				}) // 调用抛出的实例方法即可
